...
/// The iOS implementation of [MyCobraPluginPlatform].
class MyCobraPluginIOS extends MyCobraPluginPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('my_cobra_plugin_ios');

  /// Registers this class as the default instance of [MyCobraPluginPlatform]
  static void registerWith() {
    MyCobraPluginPlatform.instance = MyCobraPluginIOS();
  }
